...
class AdwordsandroidModule : public titanium::Proxy
{
public:
	explicit AdwordsandroidModule(jobject javaObject);
...
private:
	...
	// Methods -----------------------------------------------------------
	static void sendRequest(const v8::FunctionCallbackInfo<v8::Value>&);
